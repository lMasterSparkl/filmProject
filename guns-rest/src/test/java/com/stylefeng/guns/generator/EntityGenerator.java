...
public class EntityGenerator {
    ...
    public void entityGenerator() {
        ...
        gc.setOutputDir("D:\\code\\spring\\film\\guns-rest\\src\\main\\java");//这里写你自己的java目录
        ...
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/toutiao?serverTimezone=GMT&characterEncoding=utf8");
        ...
        strategy.setInclude(new String[]{"news"});

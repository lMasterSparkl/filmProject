...
public class EntityGenerator {
    ...
    public void entityGenerator() {
        ...
        gc.setOutputDir("G:\\workspace\\idea12\\film\\guns-user\\src\\main\\java");//这里写你自己的java目录
        gc.setFileOverride(true);//是否覆盖
        gc.setActiveRecord(true);
        gc.setEnableCache(false);// XML 二级缓存
        gc.setBaseResultMap(true);// XML ResultMap
        gc.setBaseColumnList(false);// XML columList
        gc.setAuthor("zhaolan");
        ...
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/hrm_db3?serverTimezone=GMT&characterEncoding=utf8");
        ...
        strategy.setInclude(new String[]{"user_inf"});
        ...
        pc.setController("com.stylefeng.guns.rest.controll");    //本项目没用，生成之后删掉
